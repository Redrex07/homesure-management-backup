...
function LoginPage() {
  ...
  const [email, setEmail] = reactExports.useState("demo@homesure.app");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthShell, { title: "Welcome back", subtitle: "Sign in to your HomeSure workspace.", footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/forgot-password", className: "text-xs font-medium text-primary hover:underline", children: "Forgot?" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "pw", type: "password", value: password, onChange: (e) => setPassword(e.target.value), required: true })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Sign in as (demo)" }),
