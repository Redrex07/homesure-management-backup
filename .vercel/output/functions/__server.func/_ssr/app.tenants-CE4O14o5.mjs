...
import { t as tenants } from "./mock-data-rNC_n49y.mjs";
import { r as Plus, s as Mail } from "../_libs/lucide-react.mjs";
...
function TenantsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Tenants", description: "Manage tenant profiles and lease details.", actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "mr-2 h-4 w-4" }),
      " Invite tenant"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DataTable, { rows: tenants, filterKeys: ["name", "email", "property"], columns: [{
      key: "name",
      header: "Tenant",
      sortable: true,
      render: (t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      key: "rent",
      header: "Rent",
      render: (t) => t.rent ? `₹${t.rent.toLocaleString()}` : "—"
    }, {
      key: "status",
      header: "Status",
      ...
      key: "actions",
      header: "",
      render: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4" }) })
    }] })
  ] });
}
export {
